...
export class NFeService {
	...
	//references
	get_search_references(queryParams: any): Observable<any[]> {
		return this.http.get<any[]>(`${this.url}/nfe/references`, { params: queryParams });
	}
	get_references(nfe_id: any): Observable<any[]> {
		return this.http.get<any[]>(`${this.url}/nfe/references/${nfe_id}`);
	}
	create_references(data: any): Observable<any[]> {
		return this.http.post<any[]>(`${this.url}/nfe/references`, data);
	}
	delete_references(id: number): Observable<any[]> {
		return this.http.delete<any[]>(`${this.url}/nfe/references/${id}`);
	}
}
